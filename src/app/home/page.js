    ...
    return <div className={style.informationContainer}>
        <div className={style.containerRows}>
            <div>
                ...
                <h6 className={style.subtitle}>Some info may be visible to other people</h6>
            </div>
            <Link href="/" className={style.editBtn}>Edit</Link>
        </div>
        <div className={style.containerRows}>
            <span className={style.label}>Photo</span>
            <Image src="/icon/avatar.jpg" width={72} height={72} alt="avatar" style={{borderRadius:'8px'}} className={style.value}/>
        </div>
        <div className={style.containerRows}>
        ...
        <div className={style.containerRows}>
            ...
            <p className={style.value}>I am a software developer and a big fan of devchallenges...</p>
        </div>
        <div className={style.containerRows}>
